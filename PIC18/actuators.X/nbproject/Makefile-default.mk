...
FINAL_IMAGE=${DISTDIR}/actuators.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/actuators.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
